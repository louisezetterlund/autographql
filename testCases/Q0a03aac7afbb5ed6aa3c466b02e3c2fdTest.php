...
class Q0a03aac7afbb5ed6aa3c466b02e3c2fdTest extends WebTestCase
{
    ...
    public function testFoo()
    {
        ...
        $query = <<<'JSON'
{"query":"query savedSearchResultsQuery($_v0_ids: [String!]) {\n  searchResults(ids: $_v0_ids) {\n    id\n    name\n    url\n    __typename\n    ... on CompanyResultItem {\n      tickerSymbol\n      __typename\n    }\n    ... on EventResultItem {\n      startTime\n      endTime\n      __typename\n    }\n    ... on VideoResultItem {\n      timestamp\n      __typename\n    }\n    ... on ResearchArticleResultItem {\n      timestamp\n      authorName\n      authorTitle\n      type\n      __typename\n    }\n  }\n}\n","variables":{"_v0_ids":["fe529bde-8c95-336c-9dd8-3f817ea2b9dc","adbd7b79-64e7-334d-9d41-3ee33d988b3f","4189f22d-4d53-303d-9c5b-9b537e3d9db1"]},"operationName":"savedSearchResultsQuery"}
JSON;
